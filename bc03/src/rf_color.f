...
!102	format (f10.6,3f10.4,1pe12.3,1x,0p3f10.4,2x,f10.4,1p7e12.4)
...
!		write (1000, '(201(a,3x))') '# logage_yr',trim(h(0)),(trim(h(int(s(i)))),i=1,p)
!		write (1000, '(201(a,2x))') '# logage_yr',     h(0),(h(int(s(i))),i=1,p)
		write (1000, '(201(a   ))') '# logage_yr',     h(0),(h(int(s(i))),i=1,p)
